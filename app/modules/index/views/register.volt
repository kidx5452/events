            ...
            <div class="account">
                <div id="tab-regis">
                    <form action="/index/register" method="post">
                        <div class="title"></div>
                        <div class="kq-rg"></div>
                        <p><span class="ac-acc"></span><input id="username-rg" type="text" placeholder="Tên đăng nhập" name="username" value="{{ object.username }}"></p>

                        <p><span class='ac-mail'></span><input id="email-rg" type="text" placeholder="Email" name="email" value="{{ object.email }}">
                        </p>

                        <p><span class='ac-phone'></span><input id="phone-rg" type="text" placeholder="Phone" name="sdt" value="{{ object.sdt }}">
                        </p>
...
<script>
    {% if registerMessage is not empty %}
